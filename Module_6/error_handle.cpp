...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "Option 2: Pirnt linked list: " << endl;      // done
        cout << "Option 3: Insert at any position: " << endl; // done
        cout << "Option 4: Insert at Head: " << endl;         // done
        cout << "Option 5: Deleted from position: " << endl;  // done
        cout << "Option 6: Deleted Head: " << endl;  //done
        cout << "Option 7: Terminated: " << endl;  //done
        int op;
        cin >> op;
        if (op == 1)
        {
